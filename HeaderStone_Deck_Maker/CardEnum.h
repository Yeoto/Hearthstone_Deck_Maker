...
enum E_CARDRARITY
{
	E_CARDRARITY_NONE = 0x0,	// 있으면 안됨
	E_CARDRARITY_FREE = 0x1,	// 무료카드
	E_CARDRARITY_COMMON = 0x2,	// 일반카드
	E_CARDRARITY_RARE = 0x4,	// 희귀카드
	E_CARDRARITY_EPIC = 0x8,	// 특급카드
	E_CARDRARITY_LEGENDARY = 0x10,	// 전설카드
	E_CARDRARITY_ALL = 0x1F
};
